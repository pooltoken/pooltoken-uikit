...
var Icon$w = function (props) {
    return (React__default['default'].createElement("div", { style: {
        ...
        React__default['default'].createElement("svg", { viewBox: "0 0 32 32", xmlns: "http://www.w3.org/2000/svg" },
            React__default['default'].createElement("g", { fill: "#fff", "fill-rule": "evenodd" },
                React__default['default'].createElement("path", { d: "M4 0h12v16H0V4a4 4 0 0 1 4-4z", fill: "#fff" }),
                React__default['default'].createElement("path", { d: "M16 16h16v12a4 4 0 0 1-4 4H16V16z", fill: "#fff" }),
                React__default['default'].createElement("path", { d: "M11.5 20.5H.5v1h10v10h1v-11z", stroke: "#fff", "stroke-width": "2", transform: "matrix(-1 0 0 1 12 0)" }),
                React__default['default'].createElement("path", { d: "M31.5.5h-11v1h10v10h1V.5z", stroke: "#fff", "stroke-width": "2", transform: "matrix(1 0 0 -1 0 12)" })))));
};
...
styled__default['default'](Icon$I)(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate$1);
styled__default['default'](Icon$J)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
var Spinner = function (_a) {
    _a.size;
    return (React__default['default'].createElement(Container$1, null,
        React__default['default'].createElement("svg", { width: "67", height: "67", viewBox: "0 0 67 67", xmlns: "http://www.w3.org/2000/svg", stroke: "#fff" },
            React__default['default'].createElement("g", { fill: "#4858ff", "fill-rule": "evenodd" },
                React__default['default'].createElement("g", { transform: "translate(1 1)", "stroke-width": "2" },
                    React__default['default'].createElement("circle", { cx: "5", cy: "50", r: "8" },
                        React__default['default'].createElement("animate", { attributeName: "cy", begin: "0s", dur: "1.8s", values: "50;5;50;50", calcMode: "linear", repeatCount: "indefinite" }),
                        React__default['default'].createElement("animate", { attributeName: "cx", begin: "0s", dur: "1.8s", values: "5;27;49;5", calcMode: "linear", repeatCount: "indefinite" })),
                    React__default['default'].createElement("circle", { cx: "27", cy: "5", r: "8" },
                        React__default['default'].createElement("animate", { attributeName: "cy", begin: "0s", dur: "1.8s", from: "5", to: "5", values: "5;50;50;5", calcMode: "linear", repeatCount: "indefinite" }),
                        React__default['default'].createElement("animate", { attributeName: "cx", begin: "0s", dur: "1.8s", from: "27", to: "27", values: "27;49;5;27", calcMode: "linear", repeatCount: "indefinite" })),
                    React__default['default'].createElement("circle", { cx: "49", cy: "50", r: "8" },
                        React__default['default'].createElement("animate", { attributeName: "cy", begin: "0s", dur: "1.8s", values: "50;50;5;50", calcMode: "linear", repeatCount: "indefinite" }),
                        React__default['default'].createElement("animate", { attributeName: "cx", from: "49", to: "49", begin: "0s", dur: "1.8s", values: "49;5;27;49", calcMode: "linear", repeatCount: "indefinite" })))))));
};
...
var Icon$L = function (props) {
    ...
    // </Svg>
    React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 2500.01 2500" }, props),
        React__default['default'].createElement("g", { id: "Layer_2", "data-name": "Layer 2" },
            React__default['default'].createElement("g", { id: "Layer_1-2", "data-name": "Layer 1" },
                React__default['default'].createElement("path", { className: "cls-1", fill: "currentColor", d: "M764.48,1050.52,1250,565l485.75,485.73,282.5-282.5L1250,0,482,768l282.49,282.5M0,1250,282.51,967.45,565,1249.94,282.49,1532.45Zm764.48,199.51L1250,1935l485.74-485.72,282.65,282.35-.14.15L1250,2500,482,1732l-.4-.4,282.91-282.12M1935,1250.12l282.51-282.51L2500,1250.1,2217.5,1532.61Z" }),
...
var Icon$R = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 512 512" }, props),
        React__default['default'].createElement("path", { d: "m454 0h-396c-11.046 0-20 8.954-20 20v396c0 11.046 8.954 20 20 20h113.716l70.142 70.142c7.81 7.81 20.473 7.811 28.284 0l70.142-70.142h113.716c11.046 0 20-8.954 20-20v-396c0-11.046-8.954-20-20-20zm-20 396h-102c-5.304 0-10.392 2.107-14.142 5.858l-61.858 61.858-61.858-61.858c-3.75-3.751-8.838-5.858-14.142-5.858h-102v-356h356zm-158.296-196.693v96.238c0 6.063-8.841 12.125-19.703 12.125-11.367 0-19.45-6.062-19.45-12.125v-96.238c0-7.073 8.083-11.872 19.45-11.872 10.862 0 19.703 4.799 19.703 11.872zm-40.415-53.298c0-9.599 9.093-17.934 20.712-17.934 11.367 0 20.46 8.335 20.46 17.934s-9.093 18.187-20.46 18.187c-11.619 0-20.712-8.588-20.712-18.187z" })));
};
...
var Icon$W = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("path", { d: "M5,12.4V16c0,3.4,4.8,6,11,6s11-2.6,11-6v-3.6c-2.2,2.2-6.2,3.6-11,3.6S7.2,14.6,5,12.4z" }),
            React__default['default'].createElement("path", { d: "M5,20.4V24c0,3.4,4.8,6,11,6s11-2.6,11-6v-3.6c-2.2,2.2-6.2,3.6-11,3.6S7.2,22.6,5,20.4z" }),
            React__default['default'].createElement("ellipse", { cx: "16", cy: "8", rx: "11", ry: "6" }))));
};
...
var Logo$1 = function (_a) {
    ...
    var innerLogo = (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement("div", { style: {
            ...
            React__default['default'].createElement("svg", { viewBox: "0 0 32 32", xmlns: "http://www.w3.org/2000/svg" },
                React__default['default'].createElement("g", { fill: "#4858ff", "fill-rule": "evenodd" },
                    React__default['default'].createElement("path", { d: "M4 0h12v16H0V4a4 4 0 0 1 4-4z", fill: "#4858ff" }),
                    React__default['default'].createElement("path", { d: "M16 16h16v12a4 4 0 0 1-4 4H16V16z", fill: "#4858ff" }),
                    React__default['default'].createElement("path", { d: "M11.5 20.5H.5v1h10v10h1v-11z", stroke: "#4858ff", strokeWidth: "2", transform: "matrix(-1 0 0 1 12 0)" }),
                    React__default['default'].createElement("path", { d: "M31.5.5h-11v1h10v10h1V.5z", stroke: "#4858ff", strokeWidth: "2", transform: "matrix(1 0 0 -1 0 12)" })))),
        React__default['default'].createElement(Text, { fontWeight: "bold" }, "PoolToken")));
...
var socials = [
    {
        ...
        items: [
            {
                label: "English",
                href: "https://t.me/pooltokenfinancechat",
            },
            {
                label: "Announcements",
                href: "https://t.me/pooltokenfinance",
            },
        ],
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/token_pool",
    },
];
var MENU_HEIGHT = 64;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#0B2C7B", textDisabled: "#BDC2C4", textSubtle: "#1557d5", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#100C18", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", inputSecondary: "#66578D", primaryDark: "#0098A1", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#0EC5F0", borderColor: "#524B63", card: "#27262c", gradients: {
